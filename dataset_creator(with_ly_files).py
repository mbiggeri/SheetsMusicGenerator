...
GM_INSTRUMENT_MAP = {
    ...
    # ... Puoi continuare ad aggiungere altri strumenti GM qui
    # Percussioni sono solitamente sul canale 10 e non usano program change per cambiare kit,
    # ma un program change su un canale non di percussione potrebbe indicare uno strumento melodico.
}
