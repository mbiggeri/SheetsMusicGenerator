...
# USAGE
#----------------------
# `python dataset_creator.py --output_mode classic`
# `python dataset_creator.py --output_mode chunked  --force_tokenizer_build` if you want to subdivide in chunks
...
BASE_DATA_DIR = Path("./Datasets/adl-piano-midi")
