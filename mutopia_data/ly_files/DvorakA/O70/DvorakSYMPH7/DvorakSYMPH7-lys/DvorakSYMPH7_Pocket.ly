%{
  ...
  * Ver 1.0 : 01/11/2013                                                *
  *                                                                     *
  * Symphonie n°7 : partition de poche                                  *
  *                                                                     *
  * Pas de Midi généré                                                  *
  *                                                                     *
  * *****************************                                       *
...
%{
  ...
  * IMPORTANT                                                                   *
  *                                                                             *
  * La partition au format d'étude est prévue pour une impression               *
  * en mode "livret" sur papier A4 - et donc avec un résultat au format A5.     *
  *                                                                             *
  * Pour l'impression, utiliser Acrobat Reader à partir de la vesrion 8,        *
  * ou un programme équivalent (PDF-Viewer - gratuit)                           *
  *                                                                             *
  * IMPORTANT                                                                   *
  *                                                                             *
  * This study score is scheduled for printing in "booklet" on A4 paper -       *
  * and therefore with an A5 result.                                            *
  *                                                                             *
  * To print this document, use Acrobar Reader, version 8 or greater,           *
  * or other equivalent program so "PDF-Viewer" - free                          *
  *                                                                             *
  *******************************************************************************
%}
...
\include  "Common/Paper-pocket.ly"
...
\include "Common/Dimension-pocket.ly"
...
\include  "DvorakSYMPH7M3/DvorakSYMPH7M3_StavesPocket.ly"
...
\include  "DvorakSYMPH7M4/DvorakSYMPH7M4_StavesPocket.ly"

\include "Common/Couverture-pocket.ly"
...
\book {
  ...
  % Pages blanches - il faut arriver à un multiple de 4 pages pour l'ensemble
  \bookpart {
    \paper {
      print-page-number = ##f
    }
